		...
		<div class="active item">
			<div class="question_block">
				<form method="post" action="#" name="question_o/n_1">
				   ...
				   <input type="submit" name="validation" class="btn btn-primary" value="Valider" disabled <a href="#myCarousel" data-slide="next"></a></input>
				</form>
			</div>
		</div>
		...
		<div class="item">
			<div class="question_block">
				...
				<p>
				   ...
				   <input type="submit" name="validation" class="btn btn-primary" value="Envoyer" <a href=""></a></input>
				</p>
				</form>
			</div>
		</div>		
